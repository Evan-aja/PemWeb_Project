...
<head>
    ...
    <link rel="stylesheet" href="/css/tenorBulanan.css">
...
<body>
    ...
    <div class="whitebox">
        ...
        <form action="belumtau.php">
            ...
            <input type="button" value="6" class="pilihanTenor">

            <input type="button" value="12" class="pilihanTenor">
        </form>
        <h2 class="bulan">Bulan</h2>
        </div>
